<?php
  ...
  if ($etape == "validerConsult") { // l'utilisateur valide ses nouvelles données
      ...
      $existeFicheFrais = existeFicheFrais($idConnexion, $moisSaisi, "c54");
      ...
      if ( !$existeFicheFrais ) {
          ...
          $tabFicheFrais = obtenirDetailFicheFrais($idConnexion, $moisSaisi, "c54");
      }
  }                                  
?>

 <div id="contenu">
      <h2>Validation de fiches de frais</h2>
      ...
      <p>
        ...
        <select id="lstMois" name="lstMois" title="Sélectionnez le mois souhaité pour la fiche de frais">
            <?php
                ...
                $req = obtenirReqMoisFicheFrais("c54");
...
?>
    ...
    <div class="encadre">
    <p>En attente de validation : <?php echo $tabFicheFrais["montantValide"] ;
        ?>              
    </p>
	...
	<?php          
            ...
            $req = obtenirReqEltsForfaitFicheFrais($idConnexion,$moisSaisi, "c54");
...
<?php          
            ...
            $req = obtenirReqEltsHorsForfaitFicheFrais($idConnexion,$moisSaisi, "c54");
  ...
  ?>
    ...
    <form action="/appliFrais/validation.php" method="post"> 
        <input type="radio" id="valider" name="choice" value="valider">
        <label for="valider">Valider</label><br>
        <input type="radio" id="refuser" name="choice" value="refuser">
